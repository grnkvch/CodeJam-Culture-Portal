...
const team = [
  {
    ...
    src:
      'https://avatars1.githubusercontent.com/u/29776065?s=400&u=3d49e6fc037f776565828ebf86f6d5f6aaeca297&v=4',
  },
  {
  ...
  },
  {
    ...
    src:
      'https://avatars3.githubusercontent.com/u/20840745?s=400&u=c7b401a4a46e72ca40bb7cdc1d59fb5f4f75e10a&v=4',
  },
  {
    name: 'Антон Крутенок',
  ...
  return (
    <Layout>
      <h3 style={{ textAlign: 'center' }}>
        {t(`indDescrTitleP1`)} <br /> {t(`indDescrTitleP2`)}
      </h3>
      <div className="description">
        ...
        <div style={{ marginTop: '12px' }}>
          ...
          <a
            target="_blank"
            href="https://ru.wikipedia.org/wiki/%D0%91%D0%B0%D0%BB%D0%B0%D1%88%D0%BE%D0%B2,_%D0%94%D0%BC%D0%B8%D1%82%D1%80%D0%B8%D0%B9_%D0%9C%D0%B8%D1%85%D0%B0%D0%B9%D0%BB%D0%BE%D0%B2%D0%B8%D1%87"
            className="Balashov"
          >
            {' '}
            {t(`indDescrSecondP3`)}
...
export const postQuery = graphql`
  query($lng: String!) {
    ...
    javascriptFrontmatter(
      frontmatter: { authorOfTheDay: { eq: "true" }, lng: { eq: $lng } }
    ) {
      frontmatter {
        lng
        name
