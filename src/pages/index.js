...
const IndexPage = () => (
  <Layout>
    ...
    <p className="description">
      ...
      <div style={{marginTop :"12px"}}><i>"...Меняется лик земли. И только перо летописца дерзает удержать на ветхих страницах хартий приметы текучего вихря, исчезающего в небытии. Трудись, летописец! Ветер времени листает страницы судьбы"</i>, — писал 
      <a target="_blank" href="https://ru.wikipedia.org/wiki/%D0%91%D0%B0%D0%BB%D0%B0%D1%88%D0%BE%D0%B2,_%D0%94%D0%BC%D0%B8%D1%82%D1%80%D0%B8%D0%B9_%D0%9C%D0%B8%D1%85%D0%B0%D0%B9%D0%BB%D0%BE%D0%B2%D0%B8%D1%87" className="Balashov"> Дмитрий Балашов</a>, реконструировавший по разрозненным летописным, архивным источникам историю не одного народа. </div>
